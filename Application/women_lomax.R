...
target <- function(y) profile_loglik_cens_pwlomax(p = c(0, y), df)
...
fit_alpha_1 <- mle_cens_pwlomax(df, fit_p_1)
...
fit_alpha_2 <- mle_cens_pwlomax(df, fit_p_2)
...
fit_alpha_3 <- mle_cens_pwlomax(df, fit_p_3)

# AIC ---------------------------------------------------------------------

AIC_1 <- 2 * 3 - 2 * loglik_cens_pwlomax(fit_alpha_1, df, fit_p_1)
AIC_2 <- 2 * 5 - 2 * loglik_cens_pwlomax(fit_alpha_2, df, fit_p_2)
AIC_3 <- 2 * 7 - 2 * loglik_cens_pwlomax(fit_alpha_3, df, fit_p_3)

# BIC ---------------------------------------------------------------------

BIC_1 <- log(n) * 3 - 2 * loglik_cens_pwlomax(fit_alpha_1, df, fit_p_1)
BIC_2 <- log(n) * 5 - 2 * loglik_cens_pwlomax(fit_alpha_2, df, fit_p_2)
BIC_3 <- log(n) * 7 - 2 * loglik_cens_pwlomax(fit_alpha_3, df, fit_p_3)
